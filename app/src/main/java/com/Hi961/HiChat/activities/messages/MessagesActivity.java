package com.Hi961.HiChat.activities.messages;
...
import com.Hi961.HiChat.activities.profile.ProfileActivity;
...
import com.Hi961.HiChat.adapters.recyclerView.messages.MessagesAdapter;
import com.Hi961.HiChat.animations.AnimationsUtil;
import com.Hi961.HiChat.animations.ViewAudioProxy;
...
import com.Hi961.HiChat.presenters.messages.MessagesPresenter;
...
*/
    ...
    private void launchAttachRecordVideo() {
        ...
        if (PermissionHandler.checkPermission(this, Manifest.permission.CAMERA)) {
            ...
            Uri mProcessingPhotoUri;
            if (AppHelper.isAndroid7())
                mProcessingPhotoUri = FilesManager.getOutputMediaFileUri(MEDIA_TYPE_VIDEO);
            else
                ...
                switch (requestCode) {
                    ...
                    case AppConstants.SELECT_MESSAGES_CAMERA:
                        if (data.getData() != null) {
                            if (AppHelper.isAndroid7())
                                FileImagePath = FilesManager.saveToInternalStorage(this, data.getData(), MEDIA_TYPE_IMAGE);
                            else
                                FileImagePath = FilesManager.getPath(getApplicationContext(), data.getData());
                            if (FileImagePath != null) {
                                file = new File(FileImagePath);
    ...
    public void updateGroupInfo(GroupsModel groupsModel) {
        ...
        if (bitmap != null) {
            ...
            WhatsCloneImageLoader.loadCircleImageGroup(this, EndPoints.ROWS_IMAGE_URL + groupsModel.getGroupImage(), ToolbarImage, R.drawable.image_holder_gr_circle, AppConstants.ROWS_IMAGE_SIZE);
        }
    ...
    public void updateContactRecipient(ContactsModel contactsModels) {
        ...
        if (bitmap != null) {
            ...
            WhatsCloneImageLoader.loadCircleImage(this, EndPoints.ROWS_IMAGE_URL + contactsModels.getImage(), ToolbarImage, R.drawable.image_holder_ur_circle, AppConstants.ROWS_IMAGE_SIZE);
        }
