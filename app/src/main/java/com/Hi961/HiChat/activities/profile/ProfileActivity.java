...
import com.Hi961.HiChat.activities.groups.EditGroupActivity;
import com.Hi961.HiChat.activities.media.MediaActivity;
import com.Hi961.HiChat.activities.messages.MessagesActivity;
import com.Hi961.HiChat.adapters.recyclerView.groups.GroupMembersAdapter;
import com.Hi961.HiChat.adapters.recyclerView.media.MediaProfileAdapter;
...
import com.Hi961.HiChat.fragments.bottomSheets.BottomSheetEditGroupImage;
...
import com.Hi961.HiChat.presenters.users.ProfilePresenter;
...
public class ProfileActivity extends AppCompatActivity implements NetworkListener {
    ...
    private void updateUI(GroupsModel mGroupsModel, ContactsModel mContactsModel) {
        ...
        if (isGroup) {
            ...
            if (bitmap != null) {
                ...
                WhatsCloneImageLoader.loadSimpleImageGroup(this, EndPoints.PROFILE_IMAGE_URL + mGroupsModel.getGroupImage(), target, drawable, AppConstants.PROFILE_IMAGE_SIZE);
            }
           ...
           /* if (Status.length() > 18)
            ...
            if (bitmap != null) {
                ...
                WhatsCloneImageLoader.loadSimpleImage(this, EndPoints.PROFILE_IMAGE_URL + mContactsModel.getImage(), target, drawable, AppConstants.PROFILE_IMAGE_SIZE);
            }
    ...
    private void setImage(String ImageUrl) {
        ...
        if (holderBitmap != null) {
            ...
            WhatsCloneImageLoader.loadSimpleImage(this, EndPoints.PROFILE_IMAGE_URL + ImageUrl, target, drawable, AppConstants.PROFILE_IMAGE_SIZE);
        } else {
            Drawable drawable;
            drawable = AppHelper.getDrawable(this, R.drawable.image_holder_gp);
            BitmapImageViewTarget target = new BitmapImageViewTarget(UserCover) {
    ...
    private class UploadFileToServer extends AsyncTask<Void, Integer, StatusResponse> {
        ...
        private StatusResponse uploadFile() {
            ...
            APIGroups apiGroups = mApiService.RootService(APIGroups.class, PreferenceManager.getToken(ProfileActivity.this), EndPoints.BACKEND_BASE_URL);
