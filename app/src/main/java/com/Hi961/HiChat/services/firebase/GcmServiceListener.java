    ...
    private void parseRequest(Map<String, String> extras) {
        ...
        switch (extras.get("actionType")) {
            ...
            case AppConstants.SOCKET_NEW_MESSAGE_GROUP_SERVER:
                ...
                break;
/*
            case AppConstants.SOCKET_REJECT_NEW_CALL:
                mIntent = new Intent(AppConstants.SOCKET_REJECT_NEW_CALL);
                mIntent.putExtra("userSocketId", extras.get("userSocketId"));
                sendBroadcast(mIntent);
                break;
            case AppConstants.SOCKET_ACCEPT_NEW_CALL:
                mIntent = new Intent(AppConstants.SOCKET_ACCEPT_NEW_CALL);
                mIntent.putExtra("userSocketId", extras.get("userSocketId"));
                sendBroadcast(mIntent);
                break;
            case AppConstants.SOCKET_HANGUP_CALL:
                mIntent = new Intent(AppConstants.SOCKET_HANGUP_CALL);
                mIntent.putExtra("userSocketId", extras.get("userSocketId"));
                sendBroadcast(mIntent);
                break;
            case AppConstants.SOCKET_SIGNALING_SERVER:
                AppHelper.LogCat("SOCKET_SIGNALING_SERVER payload " + extras.get("payload"));
                mIntent = new Intent(AppConstants.SOCKET_SIGNALING_SERVER);
                mIntent.putExtra("from", extras.get("from_id"));
                mIntent.putExtra("signalingType", extras.get("signalingType"));
                mIntent.putExtra("label", extras.get("label"));
                mIntent.putExtra("id", extras.get("id"));
                mIntent.putExtra("candidate", extras.get("candidate"));
                mIntent.putExtra("sdp", extras.get("sdp"));
                mIntent.putExtra("init", extras.get("init"));
                mIntent.putExtra("type", extras.get("type"));
                mIntent.putExtra("payload", extras.get("payload"));
                sendBroadcast(mIntent);
                break;
            case AppConstants.SOCKET_RECEIVE_NEW_CALL:
                String callerSocketId = extras.get("from_id");
                String callerPhone = extras.get("callerPhone");
                int callerID = Integer.parseInt(extras.get("callerID"));
                String callerImage = extras.get("callerImage");
                boolean isVideoCall = Boolean.valueOf(extras.get("isVideoCall"));
