...
import com.Hi961.HiChat.helpers.images.ImageCompressionAsyncTask;
...
import static com.Hi961.HiChat.app.AppConstants.EVENT_BUS_ITEM_IS_ACTIVATED;
...
public class ConversationsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
                        ...
                        try {
                            ...
                            ImageCompressionAsyncTask imageCompression = new ImageCompressionAsyncTask() {
                                ...
                                protected void onPostExecute(byte[] imageBytes) {
                                    ...
                                    APIGroups mApiGroups = mApiService.RootService(APIGroups.class, PreferenceManager.getToken(mActivity), EndPoints.BACKEND_BASE_URL);
                                                                ...
                                                                public void onResponse(Call<GroupResponse> call, Response<GroupResponse> response) {
                                                                    if (response.isSuccessful()) {
                                                                        if (response.body().isSuccess()) {
                                                                            ...
                                                                            realm.close();
                                                                            AppHelper.Snackbar(mActivity, mActivity.findViewById(R.id.main_activity), response.body().getMessage(), AppConstants.MESSAGE_COLOR_SUCCESS, AppConstants.TEXT_COLOR);
                                                                        } else {
                                                                            conversationViewHolder.setProgressBarGroup();
                                                                            AppHelper.Snackbar(mActivity, mActivity.findViewById(R.id.main_activity), response.body().getMessage(), AppConstants.MESSAGE_COLOR_ERROR, AppConstants.TEXT_COLOR);
    ...
    class ConversationViewHolder extends RecyclerView.ViewHolder {
        ...
        void setGroupImageOffline(String ImageUrl) {
            WhatsCloneImageLoader.loadCircleImageGroup(mActivity, ImageUrl, userImage, R.drawable.image_holder_gr_circle, AppConstants.ROWS_IMAGE_SIZE);
        }
        ...
        void setGroupImage(String ImageUrl, int groupId) {
            ...
            if (bitmap != null) {
                ...
                WhatsCloneImageLoader.loadCircleImageGroup(mActivity, EndPoints.ROWS_IMAGE_URL + ImageUrl, target, R.drawable.image_holder_gr_circle, AppConstants.ROWS_IMAGE_SIZE);
            }
        ...
        void ChangeStatusUnread() {
            ...
            if (AppConstants.ENABLE_FONTS_TYPES)
                username.setTypeface(AppHelper.setTypeFace(mActivity, "Futura"));
            messageDate.setTextColor(ContextCompat.getColor(mActivity, R.color.colorAccentSecondary));
        }
        ...
        void ChangeStatusRead() {
            ...
            username.setTextColor(ContextCompat.getColor(mActivity, R.color.colorBlack));
        }
