package com.Hi961.HiChat.adapters.recyclerView.media;
            ...
            if (messagesModel.getSenderID() == PreferenceManager.getID(mActivity)) {
                ...
                if (bitmap != null) {
                    ...
                    if (FilesManager.isFileImagesSentExists(mActivity, FilesManager.getImage(messagesModel.getImageFile()))) {
                        WhatsCloneImageLoader.loadSimpleImage(mActivity, FilesManager.getFileImageSent(mActivity, messagesModel.getImageFile()), imageFile, AppConstants.ROWS_IMAGE_SIZE);
                    } else {
                        ...
                        WhatsCloneImageLoader.loadSimpleImage(mActivity, EndPoints.MESSAGE_IMAGE_URL + messagesModel.getImageFile(), target, AppConstants.ROWS_IMAGE_SIZE);
                ...
                if (bitmap != null) {
                    ...
                    if (FilesManager.isFileImagesExists(mActivity, FilesManager.getImage(messagesModel.getImageFile()))) {
                        WhatsCloneImageLoader.loadSimpleImage(mActivity, FilesManager.getFileImage(mActivity, messagesModel.getImageFile()), imageFile, AppConstants.ROWS_IMAGE_SIZE);
                    } else {
            ...
            if (messagesModel.getSenderID() == PreferenceManager.getID(mActivity)) {
                ...
                if (bitmap != null) {
                    ...
                    if (FilesManager.isFileImagesSentExists(mActivity, FilesManager.getImage(messagesModel.getVideoThumbnailFile()))) {
                        WhatsCloneImageLoader.loadSimpleImage(mActivity, FilesManager.getFileImageSent(mActivity, messagesModel.getVideoThumbnailFile()), mediaVideoThumbnail, AppConstants.ROWS_IMAGE_SIZE);
                    } else {
                        ...
                        WhatsCloneImageLoader.loadSimpleImage(mActivity, EndPoints.MESSAGE_VIDEO_THUMBNAIL_URL + messagesModel.getVideoThumbnailFile(), target, AppConstants.ROWS_IMAGE_SIZE);
                    }
                }
            } else {
                Bitmap bitmap = ImageLoader.GetCachedBitmapImage(memoryCache, messagesModel.getVideoThumbnailFile(), mActivity, messagesModel.getId(), AppConstants.USER, AppConstants.ROW_MESSAGES_AFTER);
                if (bitmap != null) {
                    ...
                    if (FilesManager.isFileImagesExists(mActivity, FilesManager.getImage(messagesModel.getVideoThumbnailFile()))) {
                        WhatsCloneImageLoader.loadSimpleImage(mActivity, FilesManager.getFileImage(mActivity, messagesModel.getVideoThumbnailFile()), mediaVideoThumbnail, AppConstants.ROWS_IMAGE_SIZE);
                    } else {
