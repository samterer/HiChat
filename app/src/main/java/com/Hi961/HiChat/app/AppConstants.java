...
public class AppConstants {
    ...
    public static final String TAG = "AnTo";
    ...
    static final boolean ENABLE_CRASH_HANDLER = true; // this for the crash activity  you can turn on this so when user get a crash this activity will appear instead of stop the app
    ...
    public static final String DEFAULT_COUNTRY_CODE = "IT";//this for country code
    /**
     * for the application
     */
    static final String APP_KEY_SECRET = "7d3d3b6c2d3683b3r5rrb51533ec6daa";// make sure this one is the same that you put on your server side (for security reasons)
