package com.Hi961.HiChat.helpers;
...
import com.Hi961.HiChat.activities.media.ImagePreviewActivity;
import com.Hi961.HiChat.activities.popups.VideoPlayerActivity;
...
public class AppHelper {
    ...
    public static void restartService() {
        if (PreferenceManager.getToken(WhatsCloneApplication.getInstance()) == null || PreferenceManager.isProvideInfo(WhatsCloneApplication.getInstance()))
            return;
